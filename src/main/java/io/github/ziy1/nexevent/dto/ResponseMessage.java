...
public class ResponseMessage<T> {
  ...
  public static <T> ResponseMessage<T> error(String path, String message) {
    return new ResponseMessage<>(
        HttpStatus.INTERNAL_SERVER_ERROR.value(), message, null, LocalDateTime.now(), path);
  }

  public static <T> ResponseMessage<T> error(
      HttpStatus status, String path, String message, T data) {
  ...
  public static <T> ResponseMessage<T> noContent(String path, String message) {
    return new ResponseMessage<>(
        HttpStatus.NO_CONTENT.value(), message, null, LocalDateTime.now(), path);
  }
}
